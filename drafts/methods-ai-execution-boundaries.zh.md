...
<!-- 草稿：中文版暂不发布（2026-08-12 决定，本版只发英文 /en/methods/ai-execution-boundaries）。
发布时：移回 docs/methods/ai-execution-boundaries.md，恢复 config.mts 的 /methods/ sidebar 分组，
并在中英两页互加切换链接 + frontmatter head 里加 hreflang 互指。 -->
